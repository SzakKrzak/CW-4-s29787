...
public class EmpDeptSalgradeTests
{
    ...
    public void ShouldReturnEmployeesFromChicago()
    {
        ...
        List<Emp> result = emps.Where(e => depts.Where(d => d.Loc.Equals("CHICAGO")).Any(d => d.DeptNo == e.DeptNo))
            .ToList();
    ...
    public void ShouldMatchEmployeeToSalaryGrade()
    {
        ...
        var result = emps
            .SelectMany(_ => grades,
                (e, g) => new { e.EName, e.Sal, g.Grade, g.Losal, g.Hisal })
    ...
    public void ShouldCalculateAverageSalaryPerDept()
    {
        ...
        var result = emps
            .GroupBy(e=>e.DeptNo)
            .Select(e=> new {AvgSal =  e.Average(e2 => e2.Sal),DeptNo = e.Key }); 
